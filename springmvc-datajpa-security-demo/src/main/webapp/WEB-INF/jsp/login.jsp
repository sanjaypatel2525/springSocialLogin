     ...
     <div class="row">
		...
		class="form-horizontal" role="form" cssStyle="width: 800px; margin: 0 auto;">
		  <div class="form-group">
		    ...
		    <div class="col-sm-4">
		      <input type="text" id="username" name="username" class="form-control" value="admin@gmail.com" placeholder="UserName" />
		    </div>
		  </div>
		  <div class="form-group">
        ...
        <div class="panel-body">
            <div class="row social-button-row">
                <div class="col-lg-4">
                    ...
                    <button class="btn btn-facebook"><i class="icon-facebook"></i> FB Login
                    </button>
                    </a>
                </div>
            </div>
